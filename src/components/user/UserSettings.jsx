...
const UserSettings = () => {
    ...
    const onSubmit = async (formData) => {
        ...
        form.append("avatar", formData.avatar.length > 0 ? formData.avatar[0] : data.avatar);
            ...
            <div className="profile-block">
                <form onSubmit={handleSubmit(onSubmit)} className="modern-form">
                    ...
                    <div className="form-actions-modern">
                        <button type="submit" className="save-button-setting">Save</button>
                        <button onClick={cancelSetting} type="button" className="cancel-button-modern">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
