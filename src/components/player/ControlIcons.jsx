             ...
             {/*   <Grid item>
                ...
                <Grid item xs={12}>
                    <Slider
                        ...
                        sx={{
                            ...
                            '& .MuiSlider-thumb': {
                                backgroundColor: '#fff', // Цвет "thumb"
                            },
                            '& .MuiSlider-track': {
                                backgroundColor: '#23c483', // Цвет дорожки
                            },
                            '& .MuiSlider-rail': {
                                backgroundColor: '#888', // Цвет рельса
                            },
                        }}
                    />
                ...
                <Grid item>
                    <Grid container alignItems='center' direction='row'>
                        ...
                        <Typography style={{color:'#fff', paddingTop:'5px'}}>{Math.round(volume * 100)}</Typography>
