...
export default class ComplaintService {
  static async getAllSortedByDateComplaint() {
    const response = await axios.get(
      `${process.env.REACT_APP_API_BASE_URL}/api/complaint`,
      {
        headers: {
  ...
  static async getComplaintTypes() {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/api/complaint/complaint-types`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
          },
  ...
  static async getLocalComplaintTypes() {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/api/complaint/local-complaint-types`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
          },
  ...
  static async getComplaintBannedUsers() {
    return await axios.get(
      `${process.env.REACT_APP_API_BASE_URL}/api/complaint-user/banned-users`,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
        },
